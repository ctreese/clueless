...
#    game_over_flag = 0
#    while game_over_flag != 1 and turn_number < 20:
#        print("It is " + players[turn_number % num_players].name + "'s turn!")
#        performTurn(players[turn_number % num_players], board)
#        turn_number += 1
#
